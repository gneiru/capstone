...
$s_qry=mysqli_query($Connection, $s_sql);
          ...
          <table id="printTable" style="border: 1px solid black; border-collapse: collapse;margin-left: 300px">
            ...
            <tr>
              ...
              <td style="font-size: 12px; border: 1px solid black;">
                ...
                <button style="background-color: #3498DB;"><a style="text-decoration: none" href="illness_delete.php?idu=<?php echo $row['id']; ?>">Edit</a></button>
                <button style="background-color: #E74C3C;"><a style="text-decoration: none" href="illness_delete.php?idd=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to delete?');">Delete</a></button>
