...
<body>
      <div class="container">
        <div class="title-page" style="margin-top: 25px;">
            <center><h3>Table Title here</h3></center>
          </div>
          ...
          <table id="printTable" style="border: 1px solid black; border-collapse: collapse;margin-left: 300px">
            ...
            <tr>
              ...
              <td style="font-size: 12px; border: 1px solid black;">
                ...
                <button style="background-color: #3498DB;"><a style="text-decoration: none" href="update_illness1.php?updateid=<?php echo $row['id']; ?>">Edit</a></button>
